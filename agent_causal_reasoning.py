...
class Agent:
    ...
    def build_causal_graph(self):
        ...
        G = nx.DiGraph()
        # Adding nodes and edges for causal reasoning
        G.add_edges_from([
            ('Action', 'Outcome'),
            ('State', 'Action'),
            ('State', 'Outcome')
    ...
    def visualize_causal_graph(self):
        ...
        plt.title("Causal Graph for Embedded Reasoning")
        plt.draw()
    ...
    def rule_based_action(self, state):
        """
    ...
    def reward_shaping(self, reward, state_old, state_new):
        ...
        if np.array_equal(state_old[7:], state_new[7:]):
            reward -= 0.2
