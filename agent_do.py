...
class Agent:
    ...
    def visualize_causal_graph(self):
        ...
        plt.title("Causal Graph with Do-Calculus")
        plt.draw()
    ...
    def do_calculus(self, state):
        """
        Apply Do-Calculus to determine the best action.
        """
        potential_rewards = self.counterfactual_reasoning(state)
        return np.argmax(potential_rewards)
